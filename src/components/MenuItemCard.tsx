          ...
          >
            ...
            <div className="p-4 flex flex-col flex-1 space-y-2">
              ...
              <Button
                ...
                className="w-full h-10 bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 hover:bg-black dark:hover:bg-white rounded-lg text-xs font-bold uppercase tracking-wider active:scale-95 transition-transform shadow-md"
              >
                Adicionar
